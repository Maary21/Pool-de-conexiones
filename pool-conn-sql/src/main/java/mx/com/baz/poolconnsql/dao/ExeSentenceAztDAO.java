...
import mx.com.baz.poolconnsql.config.DataSourceAztecaConfig;
...
@Log4j2
@Repository
public class ExeSentenceAztDAO {

	public Mono<String> getSpeiAzteca(String query){
		try {
			Connection connection = DataSourceAztecaConfig.getConnectionAzt();
...
//		JsonObject jsonArray = (JsonObject) jsonParser.parse(data);
//		
//		System.out.println("******"+jsonArray);
//		System.out.println("******"+String.valueOf(jsonArray));
//		System.out.println("******"+jsonArray.toString());
//		
//		return Mono.just(String.valueOf(jsonArray));
	}
}
